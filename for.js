...
for(var i = 0; i < weather_options.length; i++){
  console.log("Weather can be:" + weather_options [i])
}
```
...
```
var words = ["car", "bike", "bus", "van", "scooter", "truck", "rv"]
console.log(words.slice (3, 4), words.slice (0, 1), words.slice (2, 3))
for(i=0;i<= (words.slice (3, 4), words.slice (0, 1), words.slice (2, 3); i++){
console.log(i)
 }
 ```
